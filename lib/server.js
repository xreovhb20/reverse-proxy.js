...
/**
 * Gets the hostname that the server run on.
 * @property host
 * @type String
 * @default '127.0.0.1'
 * @final
...
Object.defineProperty(Server.prototype, 'host', {
  get: function() {
    return 'host' in this._options ? String(this._options.host) : '127.0.0.1';
  }
});
...
/**
 * TODO Gets the hostname...
 * @method _getHostname
 * @param {http.IncomingMessage} req The request sent by the client.
 * @return {String} TODO The hostnamee...
 * @private
 */
